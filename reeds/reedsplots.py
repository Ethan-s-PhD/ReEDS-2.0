...
def animate_dispatch(
    ...
    * The animation is created with ffmpeg (https://ffmpeg.org/).
    ...
    aggtechs = {
        ...
        **{f'tes_ms{i}': 'tes_ms' for i in [6,8,10,14]},
    ...
    plotcolors = {
        ...
        'tes_ms6': bokehcolors['tes_ms6'],
        'tes_ms8': bokehcolors['tes_ms8'],
        'tes_ms10': bokehcolors['tes_ms10'],
        'tes_ms14': bokehcolors['tes_ms14'],
...
def map_capacity_techs(
    ...
    techmap = {
        ...
        **{'battery_4':'Battery (4h)', 'battery_8':'Battery (8h)', 'pumped-hydro':'PSH', 'tes_ms6':'MSTES (6h)', 'tes_ms8':'MSTES (8h)', 'tes_ms10':'MSTES (10h)', 'tes_ms14':'MSTES (14h)'},
        **dict(zip(
...
def get_tech_colors_order(order='fuel_storage_vre'):
    ...
    for i in [f'battery_{d}' for d in [2,4,6,8,10]]+['pumped-hydro']+[f'tes_ms{d}' for d in [6,8,10,14]]:
    ...
    if order == 'fuel_storage_vre':
        plotorder = (
            ...
            + [
                ...
                if any([j in k for j in ['battery','pump','evmc', 'tes']])
            ]
        )
...
def separate_charge_discharge(df):
    ...
    storage_techs = [
        ...
        if i.startswith('battery') or i.startswith('pumped-hydro') or i.startswith('tes')
    ]
    df.loc[
