...
aggtechsplot = {
    ...
    'Nuclear': ['nuclear', 'nuclear-smr', 'nuclear-smr-tes'],
...
zctechs = vretechs + ['hydro','geothermal','nuclear','nuclear-smr','nuclear-smr-tes']
fossiltechs = ['coal','coal-ccs_mod','gas-cc','gas-cc-ccs_mod','gas-ct','o-g-s','cofire']
reccsnuctechs = retechs + ['coal-ccs_mod','gas-cc-ccs_mod','nuclear','nuclear-smr','nuclear-smr-tes']
