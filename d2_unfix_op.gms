...
GEN_HEAT.lo(i,v,r,h,t_unfix)$[thermal_storage(i)$(not csp(i))$valgen(i,v,r,t_unfix)$Sw_NuclearSMRTES] = 0 ;
GEN_HEAT.up(i,v,r,h,t_unfix)$[thermal_storage(i)$(not csp(i))$valgen(i,v,r,t_unfix)$Sw_NuclearSMRTES] = +inf ;
GEN_TES.lo(i,v,r,h,t_unfix)$[thermal_storage(i)$(not csp(i))$valgen(i,v,r,t_unfix)$Sw_NuclearSMRTES] = 0 ;
GEN_TES.up(i,v,r,h,t_unfix)$[thermal_storage(i)$(not csp(i))$valgen(i,v,r,t_unfix)$Sw_NuclearSMRTES] = +inf ;
...
STORAGE_IN_TES.lo(i,v,r,h,t_unfix)$[valgen(i,v,r,t_unfix)$thermal_storage(i)$(not csp(i))$Sw_NuclearSMRTES] = 0 ;
STORAGE_IN_TES.up(i,v,r,h,t_unfix)$[valgen(i,v,r,t_unfix)$thermal_storage(i)$(not csp(i))$Sw_NuclearSMRTES] = +inf ;
